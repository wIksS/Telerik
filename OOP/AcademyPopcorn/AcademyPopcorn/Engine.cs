...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        public int sleepThreading { get; private set; }

        public Engine(IRenderer renderer, IUserInterface userInterface, int sleepThreading)
        {
            ...
            this.sleepThreading = sleepThreading;
        }
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.sleepThreading);
